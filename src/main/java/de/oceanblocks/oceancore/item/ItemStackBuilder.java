package de.oceanblocks.oceancore.item;
...
public final class ItemStackBuilder {
     ...
     *                                  not applicable
     */
    public ItemStackBuilder withEnchantment(@NotNull Enchantment enchantment, int level) {
     ...
     * @return builder instance
     */
    public ItemStackBuilder withUnsafeEnchantment(@NotNull Enchantment enchantment, int level) {
     ...
     * @return builder instance
     */
    public ItemStackBuilder withDisplayName(@Nullable Component name) {
        withMetaValue(m -> m.displayName(name));
        return this;
    }
     ...
     * @return builder instance
     */
    public ItemStackBuilder withLore(@Nullable List<Component> lore) {
        withMetaValue(m -> m.lore(lore));
        return this;
    }
